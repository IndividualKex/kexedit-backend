...
mod tests {
    ...
    fn from_angles_zero_change_preserves_frame() {
        ...
        assert_relative_eq!(change.new_direction.x, prev.direction.x, epsilon = TOLERANCE);
        assert_relative_eq!(change.new_direction.y, prev.direction.y, epsilon = TOLERANCE);
        assert_relative_eq!(change.new_direction.z, prev.direction.z, epsilon = TOLERANCE);
    }
